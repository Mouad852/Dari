...
secrets=()
for name in POSTGRES_PASSWORD DARI_LOCATION_FUZZ_SECRET DARI_SSR_SHARED_SECRET DARI_MEDIA_S3_ACCESS_KEY DARI_MEDIA_S3_SECRET_KEY SMTP_PASSWORD; do
...
cases=(
    ...
    "missing DARI_SSR_SHARED_SECRET|DARI_SSR_SHARED_SECRET|/^DARI_SSR_SHARED_SECRET=/d"
    "missing DARI_TRUSTED_PROXY_IPS|DARI_TRUSTED_PROXY_IPS|/^DARI_TRUSTED_PROXY_IPS=/d"
    "missing DARI_RELEASE_VERSION|DARI_RELEASE_VERSION|/^DARI_RELEASE_VERSION=/d"
    "DARI_RELEASE_VERSION=latest|DARI_RELEASE_VERSION|s/^DARI_RELEASE_VERSION=.*/DARI_RELEASE_VERSION=latest/"
    ...
    "SSR shared secret too short|DARI_SSR_SHARED_SECRET|s/^DARI_SSR_SHARED_SECRET=.*/DARI_SSR_SHARED_SECRET=too-short/"
)
